...
const About = () => {
  return (
    ...
    <div className='grid sm:grid-cols-6 grid-cols-1 gap-2'>
      <a className='btn ' href='https://github.com/mustafakhanneo' target="_blank" rel="noopener noreferrer"><img className='w-[24px] h-[24px]' src={github} />Mustafa Khan</a>
      <a className='btn ' href='https://linkedin.com/in/mustafakhanneo/' target="_blank" rel="noopener noreferrer"><img className='w-[24px] h-[24px]' src={linkedin} />Mustafa Khan</a>
      <a className='btn ' href='https://x.com/mustafakhanneo' target="_blank" rel="noopener noreferrer"><img className='w-[24px] h-[24px]' src={x} />Mustafa Khan</a>
      <a className='btn ' href='https://youtube.com/@mustafakhanneo' target="_blank" rel="noopener noreferrer"><img className='w-[24px] h-[24px]' src={youtube} />Mustafa Khan</a>
      <a className='btn ' href='https://instagram.com/mustafakhanneo' target="_blank" rel="noopener noreferrer"><img className='w-[24px] h-[24px]' src={instagram} />Mustafa Khan</a>
      <a className='btn ' href='https://facebook.com/mustafakhanne' target="_blank" rel="noopener noreferrer"><img className='w-[24px] h-[24px]' src={facebook} />Mustafa Khan</a>
    </div>
