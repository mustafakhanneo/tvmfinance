  ...
  return (
    <div className="space-y-6 p-[1rem] m-auto max-w-[1280px]">
      <div class="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg font-[sans-serif] space-y-4 p-2">
            ...
            <a href="https://www.dropbox.com/scl/fi/3w86c8mmq1u95964w0aqv/tvmfinanceapp-1.0.0.apk?rlkey=n4g9d1w7t0dmmlon1adfqmqr0&st=6urramiq&dl=1" class="px-3 py-1.5 flex bg-white gap-2 mt-2 items-center rounded-xl">
  <div class="w-10">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered w-auto max-w-xs"
              />
              <button onClick={oriFuture} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered w-auto max-w-xs"
              />
              <button onClick={oriPresent} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered w-auto max-w-xs"
              />
              <button onClick={dueFuture} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered w-auto max-w-xs"
              />
              <button onClick={duePresent} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered sm:w-1/5 w-auto max-w-xs"
              />
              <button onClick={calGAnnu} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered w-auto max-w-xs"
              />
              <button onClick={calEAR} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered sm:w-1/5 w-auto max-w-xs"
              />
              <button onClick={calPrep} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
          ...
          <div className="collapse-content">
            <div className="flex sm:flex-row flex-col sm:space-x-6 space-x-0 sm:space-y-0 space-y-2">
              ...
              <NumericFormat
                ...
                className="input input-bordered sm:w-1/5 w-auto max-w-xs"
              />
              <button onClick={callGPrep} className="btn input-bordered back">
                Calculate
              </button>
              <div className="items-center input input-bordered justify-center flex">
